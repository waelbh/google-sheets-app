...
import {
  getSheetsList,
  getGoogleConnectApiUrl,
  updateDeduplicationSheets,
} from "../actions"; 
import Notification from "../helpers/Notification";
const cookies = new Cookies();
const Home: React.FC = () => {
  const [connected, setConnected] = useState<boolean>(
    cookies.get(COOKIE_NAME) ? true : false
  );
  ...
  /**
   * This method called from GoogleConnectApiForm Child to Connect API
   */
   ...
   */
  const handleDeduplicateAction = async (
